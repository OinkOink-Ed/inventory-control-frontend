...
export function ErrorBoundary() {
  ...
  if (isRouteErrorResponse(error)) {
    if (error.status === 404) {
      return (
        <div className="flex h-svh w-full flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
  ...
  if (error instanceof CustomErrorForbidden && error.status === 403) {
    return (
      <div className="flex h-svh w-full flex-col items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100 px-4">
        <div className="flex flex-col items-center text-center">
          <div className="mb-6 rounded-full bg-white p-6 shadow-lg">
  ...
  return (
    <div className="flex h-svh w-full flex-col items-center justify-center bg-gradient-to-br from-red-50 to-pink-100 px-4">
      <div className="flex flex-col items-center text-center">
        <div className="mb-6 rounded-full bg-white p-6 shadow-lg">
